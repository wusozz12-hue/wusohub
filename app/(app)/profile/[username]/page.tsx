...
import { getProfileByUsername, getFollowStats, getPostsByUser } from "@/lib/queries"
    ...
    <div className="mx-auto w-full max-w-2xl">
      <div className="border-b border-border px-4 py-6">
        ...
        <div className="mt-3 flex gap-5 text-sm">
          <span>
            <strong className="text-foreground">{formatCount(stats.following)}</strong>{" "}
            <span className="text-muted-foreground">Takip</span>
          </span>
          <span>
            <strong className="text-foreground">{formatCount(stats.followers)}</strong>{" "}
